...
var _shipMakeHelpers = require("./shipMakeHelpers");
// FLEET ENVIRONMENT
...
function createShip({ randomRange, randomLetterRangeProp, size }) {
    ...
    const randomFromRange = (0, _shipMakeHelpers.randomNumberFromRange)(randomRange[0], randomRange[1]);
    const randomLetterRange = (0, _shipMakeHelpers.randomLetterFun)(randomLetterRangeProp[0], randomLetterRangeProp[1]);
    ...
    if (size === 2) {
        ...
        const isShipDangerous = (0, _shipMakeHelpers.checkShipSafety)(twoCellShipWithSurroundings, checkFleetBusiness);
        if (isShipDangerous) return (0, _shipMakeHelpers.remakeShip)(randomRange, randomLetterRangeProp, size, createShip);
        readyEnemyShips = [
            ...readyEnemyShips,
            firstCoord,
...
},{"./shipMakeHelpers":"2URfe","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2URfe":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const closeNotificationWindow1 = function() {
    (0, _globalVarsPause.notificatonWindow1).classList.add("hidden");
// overlay.classList.add("hidden");
};
const closeNotificationWindow2 = function() {
    (0, _globalVarsPause.notificatonWindow2).classList.add("hidden");
// overlay.classList.add("hidden");
};
...
const startTimer = function(fleet, newGame = false) {
    ...
    const contraryFleet = fleet === (0, _globalVarsPause.enemySideMyFleet) ? (0, _globalVarsPause.mySideMyFleet) : (0, _globalVarsPause.enemySideEnemyFleet);
    ...
    const tick = function() {
        ...
        if (time === 0) {
            console.log((0, _gameStartControl.playingCheck).playing, "play", time);
            const fleetSide = fleet === (0, _globalVarsPause.mySideEnemyFleet) ? (0, _globalVarsPause.enemySideMyFleet) : (0, _globalVarsPause.mySideEnemyFleet);
            clearInterval(timer);
...
const selectCellsAround = function(cell) {
    ...
    const letterAround = (0, _globalVarsPause.letters).indexOf(coordSlice01);
    const previousCell = coordSlice01 + (+coordSlice1 - 1);
    const nextCell = coordSlice01 + (+coordSlice1 + 1);
    const rightCell = (0, _globalVarsPause.letters)[letterAround + 1] + coordSlice1;
    const leftCell = (0, _globalVarsPause.letters)[letterAround - 1] + coordSlice1;
    return {
        coordSlice01,
        coordSlice1,
        letterAround,
...
const toggleUsernameForm = function(fleet, display) {
    const fleetIsMySideMyFleet = fleet === (0, _globalVarsPause.mySideMyFleet);
    // Shows and hides items when it's required
    (fleetIsMySideMyFleet ? [
        (0, _globalVarsPause.username1Input),
        (0, _globalVarsPause.inputUsernameLabel1),
        (0, _globalVarsPause.submitUsername1)
    ] : [
        (0, _globalVarsPause.username2Input),
        (0, _globalVarsPause.inputUsernameLabel2),
        (0, _globalVarsPause.submitUsername2)
    ]).forEach((item)=>{
    ...
    const changeDisplayState = function(state, toggleMethod) {
        if (fleetIsMySideMyFleet) {
            (0, _globalVarsPause.changeUsernameBtn1).style.display = state;
            (0, _globalVarsPause.newGameBtn1).style.display = state;
            (0, _globalVarsPause.playerUsername1)?.classList[toggleMethod]("data");
        }
        if (!fleetIsMySideMyFleet) {
            (0, _globalVarsPause.changeUsernameBtn2).style.display = state;
            (0, _globalVarsPause.newGameBtn2).style.display = state;
            (0, _globalVarsPause.playerUsername2)?.classList[toggleMethod]("data");
        }
    };
...
},{"./config":"k5Hzs","./gameStartControl":"fXv0K","./globalVarsPause":"bAcK9","./showEndResults":"2csmh","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"k5Hzs":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const gameStartControl = function(fleet, fleetParts) {
    ...
    fleetIsEnemySideMyFleet && bothSideShips.push("enemySideMyFleet"); */ const flattenedBothSideShips = (0, _globalVars.bothSideShips).flat(2);
      ...
      flattenedBothSideShips.includes("enemySideMyFleet") */ ) {
        ...
        const defineFirstTurn = function(fleet, contraryFleet) {
            ...
            if (whoseTurn.turn === (0, _globalVars.enemySideMyFleet) && fleet === (0, _globalVars.enemySideMyFleet)) (0, _shootingLogic.computerShotHandler)();
        ...
        if (fleet === (0, _globalVars.mySideEnemyFleet) || fleet === (0, _globalVars.enemySideMyFleet)) {
            ...
            if (firstTurn >= 0.5) defineFirstTurn((0, _globalVars.enemySideMyFleet), (0, _globalVars.mySideEnemyFleet));
        }
        [
    ...
    setTimeout(async function() {
        (0, _globalVars.startGameBtn2).click();
    }, 5000);
};

},{"./config":"k5Hzs","./globalVars":"gb5d6","./helpers":"hGI1E","./shootingLogic":"6WpIw","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6WpIw":[function(require,module,exports) {
...
parcelHelpers.export(exports, "default", ()=>function(fleet, ships) {
        const shootingLogic = function(e) {
            ...
            if (fleet === (0, _globalVars.enemySideMyFleet)) {
                if (e.target.classList[0] === "dropzone") rect = (0, _globalVars.mySideMyFleet).querySelector(`.${e.target.querySelector(".cell")?.classList[0]}`).getBoundingClientRect();
                if (e.target.classList.contains("ship")) {
                    console.log("e.target", e.target);
                    rect = (0, _globalVars.mySideMyFleet).querySelector(`.${e.target?.classList[0]}`).closest(".dropzone").getBoundingClientRect();
                }
            }
            console.log("rect", rect);
            // launchBombTo(e.clientX, e.clientY);
            launchBombTo(rect.left + rect.width / 2, rect.top + rect.height / 2, fleet, e.target);
            ...
            if (fleet === (0, _globalVars.mySideEnemyFleet) && e.target.textContent === "") {
            ...
            if (fleet === (0, _globalVars.enemySideMyFleet) && e.target.textContent === "") {
            ...
            if (!selectChosenCell) {
                addMarkToFleet((0, _globalVars.enemySideEnemyFleet)).nextElementSibling.classList.add("injure");
                (0, _helpers.startTimer)(fleet);
            }
        ...
        fleet.addEventListener("click", function(e) {
            setTimeout(function() {}, (0, _globalVars.duration).duration * 1000);
            shootingLogic(e);
            computerShotHandler();
        });
    });
...
function launchBombTo(targetX, targetY, fleet, target) {
    const LAUNCH_X = fleet === (0, _globalVars.mySideEnemyFleet) ? 90 : window.innerWidth - 90;
    // 1. Create bomb
    ...
    (0, _globalVars.duration).duration = distance / 1200 + 0.5; // flight time (seconds)
    console.log("duration", (0, _globalVars.duration));
    let startTime = null;
    function animateBomb(time) {
        if (!startTime) startTime = time;
        const progress = Math.min((time - startTime) / ((0, _globalVars.duration).duration * 1000), 1);
...
function computerShotHandler() {
    try {
        ...
        if ((0, _gameStartControl.whoseTurn).turn === (0, _globalVars.enemySideMyFleet)) {
            let allMyShips = [
                ...(0, _globalVars.enemySideMyFleet).querySelectorAll("td")
            ];
            allMyShips = filterOutNonEmptyCells(allMyShips);
            // Backup to use
            ...
            if (lastDamagingShot) {
                ...
                const allSurroundingsFromFullShip = [
                    ...lastInjuredShip.map((coord)=>{
                        const dubl = (0, _shipMakeHelpers.generateSurroundingFields)({
                            lowerLetters: (0, _globalVars.lowerLetters),
                ...
                if (allSurroundingsFromFullShip.length && allSurroundingsFromFullShip.filter((coord)=>(0, _globalVars.enemySideMyFleet).querySelector(`.${coord.toUpperCase()}`).classList.contains("miss") || (0, _globalVars.enemySideMyFleet).querySelector(`.${coord.toUpperCase()}`).classList.contains("cell-around") || (0, _globalVars.enemySideMyFleet).querySelector(`.${coord.toUpperCase()}`).nextElementSibling?.classList.contains("injure")).length === allSurroundingsFromFullShip.length) {
                    allMyShips = oldShips;
                    lastInjuredShip = [];
                    lastDamagingShot = "";
                }
...
},{"./globalVars":"gb5d6","./shipMakeHelpers":"2URfe","./showEndResults":"2csmh","./gameStartControl":"fXv0K","./helpers":"hGI1E","./config":"k5Hzs","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2csmh":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./globalVarsPause":"bAcK9","./gameStartControl":"fXv0K","./helpers":"hGI1E","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"bAcK9":[function(require,module,exports) {
// FLEET ENVIRONMENT
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "bothSideShips", ()=>bothSideShips);
...
function gameControlHandler(e, fleet) {
    ...
    const turn = (0, _gameStartControl.playingCheck).playing && fleet === (0, _globalVarsPause.enemySideMyFleet) ? (0, _globalVarsPause.mySideEnemyFleet) : (0, _globalVarsPause.enemySideMyFleet);
    (0, _gameStartControl.whoseTurn).turn = turn;
    if ((0, _gameStartControl.playingCheck).playing) {
        ...
        const fleetSide = fleet === (0, _globalVarsPause.enemySideMyFleet) ? (0, _globalVarsPause.mySideMyFleet) : (0, _globalVarsPause.enemySideEnemyFleet);
...
},{"./globalVarsPause":"bAcK9","./gameStartControl":"fXv0K","./helpers":"hGI1E","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hGRP7":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./config":"k5Hzs","./gameStartControl":"fXv0K","./globalVars":"gb5d6","./helpers":"hGI1E","./placeShipsManually":"3iktl","./makeShips":"8mnMH","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["f0HGD","aenu9"], "aenu9", "parcelRequire3129")
